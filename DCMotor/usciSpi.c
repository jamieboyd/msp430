...
char uartRxBuffer [SPI_RX_BUF_SZ]; // buffer that receive data from usciA1UARTgets. referenced in header so can be accessed easily
unsigned char spiTxBuffer [SPI_RX_BUF_SZ];
